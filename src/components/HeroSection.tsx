        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-in">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold leading-tight">
              Hey! I am <span className="text-primary">Shaneeza Hasnani</span>
            </h1>
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            {socialLinks.map((link) => (
              <a
                ...
                className="flex items-center gap-2 px-6 py-3 rounded-lg bg-card/50 border border-border hover:bg-primary hover:text-primary-foreground transition-all duration-300 hover-lift group"
